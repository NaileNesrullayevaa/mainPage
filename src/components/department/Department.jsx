    ...
    return (
        <div className='department'>
            <div className="box">
                <h1>Soraqçalar</h1>
                <ul>
                    <li onClick={()=>handleClick('bolme')} className={`${dataType=="bolme" ? "active" : ""}`}><Link>Bölmələr</Link></li>
                    ...
                    <li onClick={()=>handleClick('secim')} className={`${dataType=="secim" ? "active" : ""}`}><Link>Parametr seçimləri</Link></li>
                    ...
                    <li onClick={()=>handleClick('tip')} className={`${dataType=="tip" ? "active" : ""}`}><Link>Tip</Link></li>
